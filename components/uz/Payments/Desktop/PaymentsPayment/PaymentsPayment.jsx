            ...
            <div className="container">
                <div className="row">
                    <div className="grid grid-cols-[2fr_1fr] gap-24">
                        <div>
                            <h1 className='text-36'>Дарҳол тўлов</h1>
                            <p className='text-18 font-light mt-5 my-5'>Кечикишлар ва кутишларни унутинг - пул ўтказмалари бир зумда амалга оширилади, бу сизнинг молиянгизни самарали бошқарувини таъминлайди. Unired mobile билан хизматлар учун тўлов қилинг ва бир зумда пул юборинг!</p>
