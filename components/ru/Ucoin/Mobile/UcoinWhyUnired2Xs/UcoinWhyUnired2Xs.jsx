...
export default async function UcoinWhyUnired2Xs() {
    const data = await getData()
    return (
        <section className='pt-14 pb-16 mt-16 mb-24 bg-[#F7F9FC]'>
            <div className="container">

                <h2 className="text-16-xs text-[#EF2B23]">Как это работает</h2>
                <h3 className="text-24-xs mt-5 mb-12">Делайте платежи легко и <br /> быстро</h3>
