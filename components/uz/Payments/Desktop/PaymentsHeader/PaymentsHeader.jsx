        ...
        <div className="container">
          <div className="row">
            <div>
              ...
              <p className="text-18 mt-6 mb-5">Энди сиз Unired иловаси ёрдамида Ўзбекистондаги <br /> хизматлар учун тўғридан-тўғри Россиядан туриб <br /> тўлашингиз мумкин. Ҳеч қандай мураккаб процедуралар <br /> ва комиссиялар йўқ - шунчаки тез ва қулай тўлов!</p>
