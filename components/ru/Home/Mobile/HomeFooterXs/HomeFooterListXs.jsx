        ...
        <div className='grid grid-cols-2 gap-x-9 gap-y-11'>
            <div>
                <ul className='flex flex-col gap-4'>
                    ...
                    <li>
                        <Link href={'/ru/money_transfers'} className='text-16-xs font-normal tracking-normal text-[#1C1C1C]'>Денежные переводы</Link>
                    </li>
                    <li>
                        <Link href={'/ru/payments'} className='text-16-xs font-normal tracking-normal text-[#1C1C1C]'>Платежи</Link>
                    </li>
                    <li>
                        <Link href={'/ru/visa_card'} className='text-16-xs font-normal tracking-normal text-[#1C1C1C]'>Карты Visa</Link>
                    </li>
                    <li>
                        <Link href={'/ru/ucoin'} className='text-16-xs font-normal tracking-normal text-[#1C1C1C]'>Ucoin</Link>
                    </li>
                    <li>
