    ...
    return (
        <section className='bg-set bg-homeUserXs pt-[310px] pb-[860px] mb-28'>
            <div className='container'>
                ...
                <p className='text-14-xs font-light text-white tracking-normal'>Вот почему мы неустанно работаем над новым удобством для пользователей и новыми сервисами каждый день. В результате в настоящее время в нашем мобильном приложении более 50 000 пользователей  которые доверяют нам.</p>
            </div>
        </section>
    )
}
