    ...
    return (
        <section>
            <div className="container mt-16 mb-[130px]">
                <div className="row">
                    <h2 className='text-18 tracking-[0.01em] font-bold text-[#EF2B23]'>Нега Unired</h2>
                    <h1 className='text-36 mt-[30px] mb-[70px]'>Ўзбекистондан бошқа давлатларга пул ўтказиш <br /> учун энг яхши мобил илова</h1>
