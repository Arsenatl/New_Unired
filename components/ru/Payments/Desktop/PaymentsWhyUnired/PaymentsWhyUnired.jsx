                            ...
                            return (
                                <div key={value}>
                                    <Image
                                        ...
                                        alt='icon'
                                    />
                                    <h3 className='text-16 w-max flex-center before:content-[" "] before:block before:h-5 before:w-[2px] before:bg-[#F44949] before:mr-5 before:-ml-5 mt-[30px] mb-10px'>{element.h2}</h3>
