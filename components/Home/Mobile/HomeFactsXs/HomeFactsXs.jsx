  ...
  return (
    <section className='bg-set bg-homeFactsXs pb-[451px] pt-[317px] -mt-[262px mb-[77px]'>
      <div className="container">
        ...
        <p className="text-14-xs text-white tracking-normal font-normal">Unired делает перемещение денег таким же простым и  удобным, как отправка  сообщений. Наши команды ежегодно обрабатывает сотни миллиарды сумов для  физических лиц и амбициозных компаний всех размеров.</p>
