  ...
  return (
    <section className='bg-[#F7F9FC] mt-28 pt-16 pb-20 mb-16'>
      <div className="container">
        <h2 className="text-24-xs">Тезкор тўлов</h2>
        <p className="text-14-xs mt-5 mb-10">Кечикишлар ва кутишларни унутинг, пул ўтказмалари бир зумда амалга оширилади. Бу сизнинг молиянгизни самарали бошқарувини таъминлайди.
          Unired mobile билан хизматлар учун тўлов қилинг ва бир зумда пул юборинг!
        </p>
